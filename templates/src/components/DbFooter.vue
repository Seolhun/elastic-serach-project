<template>
    <div class="container">
        <div class="footer-main">
            ...
            <a href="https://github.com/Seolhun/elastic_serach_example" target="_blank" class="footer-main-link">Github</a>
            <a href="mailto:shun10114@gmail.com" class="footer-main-link">Email</a>
        </div>
